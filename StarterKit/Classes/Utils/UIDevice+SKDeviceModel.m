//
//  UIDevice+SKDeviceModel.m
//  Pods
//
//  Created by shuu on 2017/4/3.
//
//
...
NSString *const Device_iPhone7plus = @"iPhone7 Plus";
NSString *const Device_Unrecognized = @"?unrecognized?";

@implementation UIDevice (SKDeviceModel)
...
- (NSString *)deviceModelString{
  ...
  NSString *deviceName = [deviceNamesByCode objectForKey:[self deviceModel]];
  if(deviceName){
    return deviceName;
  }
